...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conexion->prepare("INSERT INTO productos (codigo, nombre, precio,stock,foto) VALUES (?, ?, ?, ?,?)");
...
<header class="cabecera-negra">
    ...
    <form method="POST">
        <h1 id=subtitulo>Agregar Nuevo Producto</h1>
        ...
        <button type="submit"><strong>Guardar Producto</strong></button>
    </form>
</body>
</html>
<?php $conexion->close(); ?>